        ...
        <div class="uk-container uk-margin-top">
            <form>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <vue-google-autocomplete ref="location" v-model="location" id="form-location" class="uk-input uk-form-width-large" enable-geolocation placeholder="Start typing" v-on:placechanged="getLocationData">
